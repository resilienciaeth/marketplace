    ...
    <div className="flexBetweenStart my-5">
      <div className="flex-1 flexStartCenter">
        ...
        <div className="flexCenterStart flex-col ml-5">
          ...
          <p className="font-poppins dark:text-white text-nft-black-1 font-normal text-sm minlg:text-xl">{nft.name} </p>
  ...
  return (
    <div className="relative flex justify-center md:flex-col min-h-screen">
      <div className="relative flex-1 flexCenter sm:px-4 p-12 border-r md:border-r-0 md:border-b dark:border-nft-black-1 border-nft-gray-1">
        <div className="relative w-557  h-557">
      ...
      <div className="flex-1 justify-start sm:px-4 p-12 sm:pb-4">
        ...
        <div className="mt-10">
          <p className="font-poppins dark:text-white text-nft-black-1 text-xs minlg:text-base font-normal">Creador</p>
          <div className="flex flex-row items-center mt-3">
            <div className="relative w-12 h-12 minlg:w-20 minlg:h-20 mr-2">
              <Image src={images.creator9} objectFit="cover" className="rounded-full" />
            </div>
      ...
      <Modal
        ...
        body={(
          <div className="flexCenter flex-col text-center" onClick={() => setSuccessModal(false)}>
            ...
            <p className="font-poppins dark:text-white text-nft-black-1 font-normal text-sm minlg:text-xl">Enhorabuena! Acabas de comprar: <span className="font-semibold">{nft.name}</span></p>
          </div>
      )}
        footer={(
