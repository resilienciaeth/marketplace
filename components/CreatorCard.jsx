...
const CreatorCard = ({ rank, creatorImage, creatorName, creatorEths }) => {
  ...
  return (
    <div className="min-w-190 minlg:min-w-240 dark:bg-nft-black-3 bg-white border-nft-gray-1 rounded-3xl flex flex-col p-4 m-4">
      <div className="w-8 h-8 minlg:w-11 minlg:h-11 bg-nft-blue-meta flexCenter rounded-full">
      ...
      <div className="my-2 flex justify-center">
        <div className="relative w-20 h-20 minlg:w-28 minlg:h-28">
          ...
          />
          <div className="absolute w-8 h-8 minlg:w-11 minlg:h-11 -bottom-2 -right-0">
            <Image
              src={images.tick}
              layout="fill"
              className="rounded-full"
